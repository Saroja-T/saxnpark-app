                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(vehicleDetails[index].vehicleName!,style: customTextStyle(16, FontWeight.w400, AppColors.black6, 1),),
                                Text(vehicleDetails[index].vehicleCategory!,style: customTextStyle(14, FontWeight.w400, AppColors.grey6, 1.5),),
                              ],
                            )
                            // Text(Strings.myDetails,style: customTextStyle(16, FontWeight.w400, AppColors.black6, 1),),
                          ],
                        ),
                        if (index == 0)IconButton(onPressed: (){}, icon: const Icon(Icons.delete_outline_rounded))
                      ],
                    ),
                  ],
                ),
                  ...
                  children: [
                    Row(
                      children: [
                        Image.asset(add),
                        const SizedBox(width: 16),
                        Text(Strings.addVehicle,style: customTextStyle(14, FontWeight.w400, AppColors.black6, 1),)
                      ],
                    ),
                  ],
                ),
