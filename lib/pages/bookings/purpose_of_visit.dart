...
import '../../bottomsheets/signout_bottom_sheet.dart';
...
class _PurposeOfVisitState extends State<PurposeOfVisit> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // Show the bottom sheet after the widget has been fully initialized
      initBottomSheet();
    });
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: customTextStyle(16,
                                          FontWeight.w400, AppColors.black6, 1),
                                    )
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (Strings.identity == self) {
                            ...
                            context.read<LandingBloc>().add(TabChangeEvent(
                                tabIndex: 1, tabLabel: Strings.rVisitorScreen));
                          }
                        },
                        child: Row(
