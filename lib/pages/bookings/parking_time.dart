...
static int calculateTimeDifferenceBetween(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBarWithBack(title: Strings.bookingDetails,backText: Strings.back,redirectionKey: Strings.rVehicleType,tabIndex: 1,),
      body:  Container(
        child:Padding(
            ...
            child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8,),
                            Flexible(
                              child: Text(Strings.slotUnavailableWarning,
                              softWrap: true,
                              maxLines: 3,
                              style: customTextStyle(12, FontWeight.w400, AppColors.black5, 1.5),),
                            ),
                          ],
                        ),
                      ],
              ...
              Text(Strings.driveInTime,style: customTextStyle(16, FontWeight.w400, AppColors.black1, 1),),
               ...
               InkWell(
                onTap: () async 
                {
                  driveIn = await showOmniDateTimePicker(context: context,is24HourMode: true,firstDate: DateTime.now());
                  ...
                  {
                      driveInTime = "${DateFormat.yMd('es').format(driveIn!)} $timeVal";
                  }
                  });
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            Text(driveInTime,style: customTextStyle(14, FontWeight.w400, AppColors.black6, 1),),
                ...
                Text(Strings.driveOutTime,style: customTextStyle(16, FontWeight.w400, AppColors.black1, 1),),
                const SizedBox(height: 10,),
               InkWell(
                onTap: () async 
                {
                  driveOut = await showOmniDateTimePicker(context: context,is24HourMode: true,firstDate: driveIn,initialDate: driveIn);
                  ...
                  setState(() {
                    ...
                    var totHours = calculateTimeDifferenceBetween(startDate: driveOut!,endDate: driveIn!);
                    ...
                    if(totHours > 0)
                    {
                      if(aDate == today) 
                        ...
                        {
                            driveOutTime = "${DateFormat.yMd('es').format(driveOut!)} $timeVal";
                        }
                    ...
                    else
                    {
                      ...
                      showNegativeToast("Drive in time should be greater than drive out");
                    }
                  });
                    ...
                    child: Column(
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(driveOutTime,style: customTextStyle(14, FontWeight.w400, AppColors.black6, 1),),
                            Image.asset(calender)
                          ],
                        ),
                      ],
               ...
               Text(Strings.duration,style: customTextStyle(16, FontWeight.w400, AppColors.black1, 1),),
                const SizedBox(height: 10,),
               Container(
                height: 50,
                    padding: EdgeInsets.all(16),
                    ...
                    child:SizedBox.expand(child: Text(duration,style: customTextStyle(14, FontWeight.w400, AppColors.black6, 1),)),
                   ),
              Container(
                    padding: EdgeInsets.all(16),
                    margin:const EdgeInsets.only(bottom: 16),
                    child:InkWell(
                      ...
                      child: Center(child: Text(Strings.viewPrices,style: customTextStyle(16, FontWeight.w400, AppColors.black6, 1),))),
                   ),
               Container(
                height: 51,
